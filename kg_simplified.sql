...
CREATE TABLE IF NOT EXISTS Entity (
	eid				varchar(20) 	PRIMARY KEY,-- What's the diff to varchar(500)? Or 20 -> 10?
	label 			varchar(500),		-- only record en.
...
CREATE TABLE IF NOT EXISTS Claim (
	...
	value 			varchar(500), -- a representative value for faster access
	FOREIGN KEY (eid) REFERENCES Entity (eid),
