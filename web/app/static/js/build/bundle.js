...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageBoard = __webpack_require__(148);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var NERInfo = __webpack_require__(149);
	var Message = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./Message\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	var MessageForm = __webpack_require__(151);
	var SecondaryForm = __webpack_require__(152);
	...
	var MessageBoard = React.createClass({displayName: "MessageBoard",
		...
		render : function(){
			if (this.state.second_list.length) {
		        ...
		        React.createElement("h4", null, "Let's get some entities first!"), 
						...
						React.createElement("h4", null, "How about knowing more about the selected entity?"), 
						React.createElement(SecondaryForm, {submitMessage: this.submitSecondaryMessage}), 
						React.createElement("div", null, 
							React.createElement(Message, {message: this.state.second_list})
						)
					)
			}
			if (this.state.entity_list.length) {
		        ...
		        React.createElement("h4", null, "Let's get some entities first!"), 
						React.createElement(MessageForm, {submitMessage: this.submitMessage}), 
						React.createElement("div", null, 
							React.createElement(Message, {message: this.state.entity_list})
						), 
						React.createElement("h4", null, "How about knowing more about the selected entity?"), 
						React.createElement(SecondaryForm, {submitMessage: this.submitSecondaryMessage})
					)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NERInfo = React.createClass({displayName: "NERInfo",
		render : function(){
			...
			var display = type.map(function(item) {
				if (item != "o") {
					ne_type = item;
				return (
					[React.createElement("span", {className: `tag ${"format-"+ne_type}`, style: spanStyle}, ne_type)]
				)}
			});
			return(
				React.createElement("div", null, 
			    ...
			    React.createElement("form", {className: "col s12", onSubmit: this.handleSubmit}, 
			      React.createElement("div", {className: "row"}, 
			        React.createElement("div", {className: "input-field col s12"}, 
			          React.createElement("input", {id: "entity", type: "text", className: "validate", value: this.state.value, onChange: this.handleChange}), 
			          React.createElement("label", {for: "entity"}, "Describe the name of entity")
			        )
			      ), 
	...
	var MessageForm = React.createClass({displayName: "MessageForm",
	  ...
	  componentDidMount() {
		...
		render : function(){
			return(
				React.createElement("div", null, 
				  React.createElement("form", {className: "input-field col s12", onSubmit: this.handleSubmit}, 
				    React.createElement("select", null, 
				      React.createElement("option", {value: "", disabled: true, selected: true}, "Choose your option"), 
				      React.createElement("option", {value: "1"}, "Find me the hierarchies on this entity"), 
